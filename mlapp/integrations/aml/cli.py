...
from mlapp.integrations.aml.scripts.run_pipeline_from_local import run_script as run_pipeline_from_local
...
def publish_pipeline(pipeline_name, experiment_name, config_str):
    try:
        ws, datastore = _get_aml_objects()
